...
RACGP patient feedback questions (reception, privacy, care coordination), the validated **P3CEQ**
...
- charts RACGP patient feedback ratings, long-term conditions, and respondent demographics
...
The raw SurveyCTO response report needs to be placed in the project root (alongside the `.qmd`)
before rendering. The SurveyCTO form definition (`kensington_p3ceq_2026_surveycto.xlsx`, question/choice structure only — no
